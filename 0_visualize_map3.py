...
map1= np.loadtxt('txt2py_map_1_data_case3.txt',delimiter=',',skiprows=1,dtype='float32')
map2= np.loadtxt('txt2py_map_2_data_case3.txt',delimiter=',',skiprows=1,dtype='float32')
