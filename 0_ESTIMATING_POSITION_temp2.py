...
x_test= np.loadtxt('txt2py_test_x_data_case2.txt',delimiter=',',skiprows=1,dtype='float32')
y_test= np.loadtxt('txt2py_test_y_data_case2.txt',delimiter=',',skiprows=1,dtype='float32')
