...
with tf.Session() as sess:
    # initialize
    train_writer=tf.summary.FileWriter('./tensorboard_log3',sess.graph) #텐서보드 display용
    test_writer=tf.summary.FileWriter('./tensorboard_log3',sess.graph) #텐서보드 display용
    ...
    saver.save(sess,save_file,global_step=2,write_meta_graph=False)
