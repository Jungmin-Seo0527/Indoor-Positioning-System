...
map1= np.loadtxt('txt2py_map_1_data_case4_for_map.txt',delimiter=',',skiprows=1,dtype='float32')
map2= np.loadtxt('txt2py_map_2_data_case4_for_map.txt',delimiter=',',skiprows=1,dtype='float32')
