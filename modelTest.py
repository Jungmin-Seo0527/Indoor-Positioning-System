...
x_test = np.loadtxt('fftest_x.txt', delimiter=',', skiprows=1, dtype='float32')
#y_test = np.loadtxt('fftest_y.txt', delimiter=',', skiprows=1, dtype='float32')
...
W1 = tf.get_variable("W1", shape=[10, 800],  ##tf.get_variable(<name>, <shape>, <initializer>): 입력된 이름의 변수를 생성하거나 반환함
...
save_file = './JJtrain_test.ckpt-999'
