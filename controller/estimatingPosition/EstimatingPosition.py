...
class EstimatingPosition:
        def __init__(self, xDataPath, yDataPath, savedFilePath):
        ...
        def showPosition(self):
            x_test = np.loadtxt(self.xDataPath, delimiter=',', skiprows=1, dtype='float32')
            y_test = np.loadtxt(self.yDataPath, delimiter=',', skiprows=1, dtype='float32')
            ...
            W1 = tf.get_variable("W1", shape=[18, 800],
                                 ##tf.get_variable(<name>, <shape>, <initializer>): 입력된 이름의 변수를 생성하거나 반환함
