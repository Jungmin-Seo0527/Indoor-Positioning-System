...
x_test= np.loadtxt('dataSet/txt2py_test_x_data_case4.txt',delimiter=',',skiprows=1,dtype='float32')
y_test= np.loadtxt('dataSet/txt2py_test_y_data_case4.txt',delimiter=',',skiprows=1,dtype='float32')
