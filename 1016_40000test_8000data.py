# maximize train set to almost 100000 for accuracy
...
x_train,x_test_not_using,y_train,y_test_not_using = train_test_split(x_data_all,y_data_all,test_size=0.2)
